...
public class MedicalManagementActivity extends AppCompatActivity {
    ...
    private void setupClickListeners() {
        ...
        btnAddFirst.setOnClickListener(v -> addMedicalRecord());
        ...
        if (fabAdd != null) {
            fabAdd.setOnClickListener(v -> addMedicalRecord());
        }
    }
        ...
        new Thread(() -> {
            ...
            runOnUiThread(() -> {
                ...
                builder.setTitle("医疗记录详情")
                        ...
                        .setNeutralButton("编辑", (dialog, which) -> editMedicalRecord(record))
                        .show();
            });
        }).start();
    }
