...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void attemptRegister() {
        ...
        if (validateInputs(username, password, confirmPassword, idCard)) {
            // 开始注册
            performRegister(username, password, idCard);
        }
    }
    ...
    private void performRegister(String username, String password, String idCard) {
        // 检查用户名是否已存在
            ...
            public void onSuccess(Boolean usernameExists) {
                ...
                userRepository.checkIdCardExists(idCard, new UserRepository.DataSourceCallback<Boolean>() {
                    ...
                    public void onSuccess(Boolean idCardExists) {
                        ...
                        // 创建新用户
                        createNewUser(username, password, idCard);
                    }
    ...
    private void createNewUser(String username, String password, String idCard) {
        // 创建新用户
