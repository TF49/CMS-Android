...
import com.example.cms_android.model.Household; // 添加Household导入
...
public class ResidentFormActivity extends AppCompatActivity {
    ...
    private void saveResident() {
        if (validateForm()) {
            ...
            record.setGender(selectedGender != null ? selectedGender : "男");
    ...
    private boolean validateForm() {
        if (spinnerHousehold.getSelectedItem() == null) {
            Toast.makeText(this, "请选择户籍", Toast.LENGTH_SHORT).show();
            return false;
        }
